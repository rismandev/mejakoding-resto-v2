...
import { View, Text, ScrollView, TouchableOpacity, Image, TextInput, BackHandler, ActivityIndicator, StyleSheet } from 'react-native';
import Icon from 'react-native-vector-icons/FontAwesome5'
import { StackActions, NavigationActions } from 'react-navigation'
import AlertPro from "react-native-alert-pro";
import AlertPro1 from "react-native-alert-pro";
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        {/* Using AlertPro for Notification */}
        <AlertPro
          ref={ref => {
            this.AlertPro = ref;
          }}
        ...
        <AlertPro2
          ...
          message="Minimum Order Rp. 20.000"
          textConfirm="Oke"
          customStyles={{
            mask: {
              backgroundColor: "transparent"
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.FormPayment}>
            ...
            <View style={[styles.FormTextInput, {borderColor: this.props.payment.valid == 1 ? 'green' : 'white'}]}>
              <TextInput
        ...
        <TouchableOpacity
          ...
          style={styles.btnCallBill}>
          <Text style={styles.textBtnCallBill}>
            <Icon
